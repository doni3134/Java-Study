    ...
    public void keyPressed(KeyEvent e) {
        ...
        switch (keyCode) {
            ...
            case KeyEvent.VK_RIGHT:
                ...
                player.move();  // Call move() immediately to update the player's position
                AttackProcess();  // Call AttackProcess() to handle attacks
                break;
...
class Attack {
    ...
    public void draw(Graphics g) {
        g.drawImage(img, x+15 , y+50 , null);   //공격 위치를 플레이어 몸쪽으로 최대한 좌표값 수정
    }
